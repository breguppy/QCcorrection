...
```{r}
QCcorrection:::ui_basic_info(params$choices$raw_df, params$choices$replacement_counts, params$choices$non_numerics_cols, params$choices$duplicate_mets, params$choices$correlated_mets)
